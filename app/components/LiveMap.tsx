...
export default function LiveMap({ logs }: LiveMapProps) {
  ...
  if (!MapWidget) {
    return (
      <div className="h-full w-full min-h-[400px] lg:min-h-[560px] bg-surface rounded-xl border border-border flex items-center justify-center text-sm font-mono text-fg-faint animate-pulse">
